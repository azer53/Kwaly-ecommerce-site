            ...
            <nav className="toggleColour" id="header">
                ...
                <div id="nav-content" className="w-full block flex-grow lg:flex lg:items-center lg:w-auto mt-8">
                    <div className="text-sm lg:flex-grow flex justify-center">
                        <Link to={`/shop`} href="#responsive-header" className="block mt-4 lg:inline-block lg:mt-0 text-gray-800 hover:text-gray-500 mx-3 lg:mx-4">
                            SHOP
      </Link>
                        <Link to={`/brand`} className="block mt-4 lg:inline-block lg:mt-0 text-gray-800 hover:text-gray-500 mx-3 lg:mx-4">
                            BRAND
      </Link>
                        <Link to={`/page-2`} className="block mt-4 lg:inline-block lg:mt-0 text-gray-800 hover:text-gray-500 mx-3 lg:mx-4">
                            SOCIAL
      </Link>
