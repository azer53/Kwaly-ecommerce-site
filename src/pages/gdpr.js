...
export default function gdpr() {
  return (
    <div className="markdown">
      ...
      <p>
        At Kwaly, accessible from www.kwaly.be, one of our main priorities is
        the privacy of our visitors. This Privacy Policy document contains types
        of information that is collected and recorded by Kwaly and how we use
        it.
      </p>
      ...
      <p>
        Kwaly legal basis for collecting and using the personal information
      ...
      <ul>
        <li>Kwaly needs to perform a contract with you</li>
        <li>You have given Kwaly permission to do so</li>
        <li>
          Processing your personal information is in Kwaly legitimate interests
        </li>
        <li>Kwaly needs to comply with the law</li>
      </ul>

      <p>
        Kwaly will retain your personal information only for as long as is
      ...
      <p>
        Kwaly follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, Kwaly uses 'cookies'. These cookies are used to
      ...
      <p>
        ...
        advertising partners of Kwaly.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Kwaly, which are sent directly
      ...
      <p>
        Note that Kwaly has no access to or control over these cookies that are
      ...
      <p>
        Kwaly's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        Kwaly does not knowingly collect any Personal Identifiable Information
      ...
      <p>
        ...
        shared and/or collect in Kwaly. This policy is not applicable to any
